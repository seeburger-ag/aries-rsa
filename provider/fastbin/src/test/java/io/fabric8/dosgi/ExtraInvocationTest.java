...
import io.fabric8.dosgi.api.FastbinDistributionProvider;
...
public class ExtraInvocationTest
{
    ...
    public void setup() throws Exception
    {
        ...
        InvocationHandler handler = client.getProxy(server.getConnectAddress(), "service-id", TestServiceImpl.class.getClassLoader(),FastbinDistributionProvider.PROTOCOL_VERSION);
    ...
    public void testInvokeWithWrongProtocolVersion() throws Exception
    {
        ...
        {
            assertEquals("Incorrect fastbin protocol 300 version. Only protocol versions up to "+FastbinDistributionProvider.PROTOCOL_VERSION+" are supported.",e.getMessage());
        }
